      ...
      <div class="tk-admin-comment-list" ref="comment-list">
        <div class="tk-admin-comment-item" v-for="comment in comments" :key="comment._id">
          ...
          <div class="tk-admin-actions">
            ...
            <ElButton size="small" :text="true" v-if="comment.isSpam" @click="handleSpam(comment, false)">{{ t('ADMIN_COMMENT_SHOW') }}</ElButton>
            <ElButton size="small" :text="true" v-if="!comment.isSpam" @click="handleSpam(comment, true)">{{ t('ADMIN_COMMENT_HIDE') }}</ElButton>
            <ElButton size="small" :text="true" v-if="!comment.rid && comment.top" @click="handleTop(comment, false)">{{ t('ADMIN_COMMENT_UNTOP') }}</ElButton>
            <ElButton size="small" :text="true" v-if="!comment.rid && !comment.top" @click="handleTop(comment, true)">{{ t('ADMIN_COMMENT_TOP') }}</ElButton>

<template>
    <div class="tk-submit">
      ...
      <div class="tk-row actions">
        ...
        <ElButton class="tk-cancel"
            v-if="!!replyId"
            size="small"
            @click="cancel">{{ t('SUBMIT_CANCEL') }}</ElButton>
        <ElButton class="tk-preview"
            size="small"
            @click="preview">{{ t('SUBMIT_PREVIEW') }}</ElButton>
        <ElButton class="tk-send"
            type="primary"
            size="small"
            :disabled="!canSend"
            @click="send">{{ isSending ? t('SUBMIT_SENDING') : t('SUBMIT_SEND') }}</ElButton>
      </div>

export default {
  ...
  el: {
    ...
    ["ADMIN_COMMENT"]: "评论管理",
    ["ADMIN_COMMENT" + "_DELETE"]: "删除",
    ["ADMIN_COMMENT" + "_DELETE_CONFIRM"]: "确认删除？",
    ["ADMIN_COMMENT" + "_FILTER_ALL"]: "全部",
    ["ADMIN_COMMENT" + "_FILTER_VISIBLE"]: "只看可见",
    ["ADMIN_COMMENT" + "_FILTER_HIDDEN"]: "只看隐藏",
    ["ADMIN_COMMENT" + "_HIDE"]: "隐藏",
    ["ADMIN_COMMENT" + "_IS_SPAM_SUFFIX"]: " (已隐藏)",
    ["ADMIN_COMMENT" + "_SEARCH"]: "搜索",
    ["ADMIN_COMMENT" + "_SEARCH_PLACEHOLDER"]:
      "搜索昵称、邮箱、网址、IP、评论正文、文章地址",
    ["ADMIN_COMMENT" + "_SHOW"]: "显示",
    ["ADMIN_COMMENT" + "_TOP"]: "置顶",
    ["ADMIN_COMMENT" + "_UNTOP"]: "取消置顶",
    ["ADMIN_COMMENT" + "_VIEW"]: "查看",
    ADMIN_CONFIG: "配置管理",
    ["ADMIN_CONFIG_CATEGORY" + "_COMMON"]: "通用",
    ["ADMIN_CONFIG_CATEGORY" + "_IM"]: "即时通知",
    ["ADMIN_CONFIG_CATEGORY" + "_MAIL"]: ["邮件通知"],
    ["ADMIN_CONFIG_CATEGORY" + "_PLUGIN"]: ["插件"],
    ["ADMIN_CONFIG_CATEGORY" + "_PRIVACY"]: ["隐私"],
    ["ADMIN_CONFIG_CATEGORY" + "_SPAM"]: ["反垃圾"],
    ...
    ["ADMIN_CONFIG_ITEM" + "_BLOGGER_NICK"]: "博主的昵称。",
    ["ADMIN_CONFIG_ITEM" + "_BLOGGER_EMAIL"]: "博主的邮箱地址，用于邮件通知、博主标识。",
    ["ADMIN_CONFIG_ITEM" + "_COMMENT_BG_IMG"]: "评论框自定义背景图片 URL 地址。",
    ["ADMIN_CONFIG_ITEM" + "_COMMENT_PAGE_SIZE"]: "评论列表分页大小，默认为 8。",
    ["ADMIN_CONFIG_ITEM" + "_COMMENT_PLACEHOLDER"]: "评论框提示信息，可用<br>换行，默认为空",
    ["ADMIN_CONFIG_ITEM" + "_CORS_ALLOW_ORIGIN"]:
      "Vercel CORS 安全域名，注意：错误设置会导致无法加载，默认为空，格式为 https://blog.example.com；如需添加多域名请使用,分隔",
    ["ADMIN_CONFIG_ITEM" +
    "_DEFAULT_GRAVATAR"]: `默认的头像显示。默认值为 "identicon"，可选：'404',
    'mp',
    'identicon',
    'monsterid',
    'wavatar',
    ...
    ["ADMIN_CONFIG_ITEM" + "_HIGHLIGHT_THEME"]: `代码高亮主题，可选：'default',
    'coy',
    'dark',
    'funky',
    'okaidia',
    ...
    ["ADMIN_CONFIG_ITEM" +
    "_IMAGE_CDN"]: `插入图片所使用的图床，目前支持：'qcloud',
    '7bu',
    'https://7bu.top',
    'smms'`,

    ["ADMIN_CONFIG_ITEM" + "_IMAGE_CDN_TOKEN"]: "图床 token。qcloud 图床无需设置",
    ...
    ["ADMIN_CONFIG_ITEM" + "_LIMIT_LENGTH"]: "评论长度限制，0 为无限制，默认：500",
    ["ADMIN_CONFIG_ITEM" + "_MAIL_SUBJECT"]: "自定义通知邮件主题，留空则使用默认主题。",
    ...
    ["ADMIN_CONFIG_ITEM" + "_MASTER_TAG"]: "博主标识自定义文字，默认为 “博主”。",
    ["ADMIN_CONFIG_ITEM" + "_NOTIFY_SPAM"]: "垃圾评论是否发送通知，默认：true",
    ["ADMIN_CONFIG_ITEM" + "_QCLOUD_SECRET_ID"]:
      "腾讯云 secret id，用于垃圾评论检测。同时设置腾讯云和 Akismet 时，只有腾讯云会生效。注册：https://twikoo.js.org/cms.html",
    ["ADMIN_CONFIG_ITEM" + "_QCLOUD_SECRET_KEY"]: "腾讯云 secret key",
    ["ADMIN_CONFIG_ITEM" +
    "_PUSHOO_CHANNEL"]: `即时消息推送平台名称，支持： 'qmsg',
    'serverchan',
    'pushplus',
    'pushplushxtrip',
    'dingtalk',
    ...
    ["ADMIN_CONFIG_ITEM" + "_DISPLAYED_FIELDS"]: "界面上展示的输入框，默认：nick,mail,link",
    ...
    ["ADMIN_CONFIG_ITEM" + "_SENDER_NAME"]: "邮件通知标题。",
    ["ADMIN_CONFIG_ITEM" + "_SHOW_EMOTION"]: "启用插入表情功能，默认为：true",
    ["ADMIN_CONFIG_ITEM" + "_SHOW_IMAGE"]: "启用插入图片功能，默认为：true",
    ["ADMIN_CONFIG_ITEM" + "_SHOW_UA"]: "是否显示用户系统和浏览器，默认为：true",
    ["ADMIN_CONFIG_ITEM" + "_SHOW_REGION"]:
      "是否显示用户 IP 属地到省，可能不准确，不支持 IPv6，默认为：false",

    ["ADMIN_CONFIG_ITEM" + "_SITE_NAME"]: "网站名称",
    ["ADMIN_CONFIG_ITEM" + "_SITE_URL"]: "网站地址",
    ["ADMIN_CONFIG_ITEM" + "_SMTP_HOST"]:
      "自定义 SMTP 服务器地址。如您已配置 SMTP_SERVICE，此项请留空。",

    ["ADMIN_CONFIG_ITEM" + "_SMTP_PASS"]: "邮件通知邮箱密码，QQ、163邮箱请填写授权码。",
    ...
    ["ADMIN_CONFIG_ITEM" + "_SMTP_SERVICE"]: `邮件通知邮箱服务商。支持：'126',
    '163',
    '1und1',
    'AOL',
    'DebugMail',
    ...
    ["ADMIN_CONFIG_ITEM" + "_SMTP_USER"]: "邮件通知邮箱用户名。",
    ...
    ["ADMIN_IMPORT"]: "导入",
    ["ADMIN_IMPORT" + "_FILE_REQUIRED"]: "未选择文件",
    ["ADMIN_IMPORT" + "_IMPORTED"]: "完成导入 ",
    ["ADMIN_IMPORT" + "_IMPORTING"]: "开始导入 ",
    ["ADMIN_IMPORT" + "_LOG"]: "日志",
    ["ADMIN_IMPORT" + "_SELECT"]: "请选择",
    ["ADMIN_IMPORT" + "_SELECT_FILE"]: "选择文件",
    ["ADMIN_IMPORT" + "_SELECT_SOURCE"]: "选择源系统",
    ["ADMIN_IMPORT" + "_SOURCE_REQUIRED"]: "未选择源系统",
    ["ADMIN_IMPORT" + "_START"]: "开始导入",
    ["ADMIN_IMPORT" + "_STARTING"]: "开始导入",
    ...
    ["ADMIN_IMPORT" + "_UPLOADED"]: "上传完成 ",
    ["ADMIN_IMPORT" + "_UPLOADING"]: "已上传 ",
    ["ADMIN_IMPORT" + "_WARN"]:
